...
def main():
    ...
    n_obs, mz_obs, phi_He_obs, phi_TC_obs, phi_Sk_obs = simulate_module1_step31(
    ...
    print(f"  phi_He_obs shape = {phi_He_obs.shape}")
    ...
    print(f"  phi_He_obs first 10 = {phi_He_obs[:10]}")
    ...
    axes[2].plot(x, phi_He_obs, "C2-o", markersize=2, label="phi_He")
    ...
    fig.suptitle("Module1 simulation output from H_trajectory_MG.npy")
    fig.tight_layout()
