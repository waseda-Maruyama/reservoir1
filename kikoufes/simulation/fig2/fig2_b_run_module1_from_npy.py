...
# fig2 の一つ上にある simulation/module1.py を読み込む
...
def main():
    ...
    print(f"\nSaved: {root / 'fig2_module1_output.npz'}")
    ...
    fig.suptitle("Module1 simulation output from H_trajectory_920_sine.npy")
    fig.tight_layout()
    fig.savefig(root / "fig2_module1_output.png", dpi=150)
    print(f"Saved plot: {root / 'fig2_module1_output.png'}")
